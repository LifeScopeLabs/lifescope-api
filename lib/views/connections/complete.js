...
import { OAuthTokenSessionTC } from "../../../schema/models/oauth-token-sessions";
...
async function completeHandler(req, res, next) {
	...
	console.log('Ran completeConnection');
	...
	if (authParams != null) {
		...
		res.redirect('https://app.lifescope.io/auth?' + authParams);
	}
		...
		console.log('Redirecting to /providers');
